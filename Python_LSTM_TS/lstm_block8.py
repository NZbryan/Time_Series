...
all_record = list(client.python_database.GZ_data_XL_KC.find({'data_level':3}))

output_path = 'F:/xgm_201806/POC/LSTM_20180808/block_output/'+'block'+str(block)+'/'
...
for k in range(block_length*(block-1),len(all_record)):
    # k = store_name[1]
    # import gc
    # gc.collect()
