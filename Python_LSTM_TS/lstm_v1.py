...
# list_names,list_date,list_weekday,list_data_length,list_data_level = [],[],[],[],[]
# list_sale_qty,list_stock_qty,list_fill_sale_qty = [],[],[]
# for j in range(len(all_record)):
#     list_names.append(all_record[j]['names'])
#     list_date.append(all_record[j]['date'])
#     list_weekday.append(all_record[j]['weekday'])
#     list_data_length.append(all_record[j]['data_length'])
#     list_data_level.append(all_record[j]['data_level'])
#     list_sale_qty.append(all_record[j]['sale_qty'])
#     list_stock_qty.append(all_record[j]['stock_qty'])
#     list_fill_sale_qty.append(all_record[j]['fill_sale_qty'])
#
# all_record_dict = {'names':list_names,'date':list_date,'weekday':list_weekday,'data_length':list_data_length,
#                    'data_level':list_data_level,'sale_qty':list_sale_qty,'stock_qty':list_stock_qty,
#                    'fill_sale_qty':list_fill_sale_qty}
# all_record_df = pd.DataFrame(all_record_dict)
# GZAnalysisData_index = list_names
